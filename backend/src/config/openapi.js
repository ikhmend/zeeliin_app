    ...
    schemas: {
      ...
      ProfileUpdate: {
        ...
        properties: {
          ...
          citizen_registration_no: { type: "string", nullable: true },
          ...
          living_address: { type: "string", nullable: true },
          employment: {
            type: "object",
            properties: {
              organization_name: { type: "string" },
              position: { type: "string" },
              worked_year: { type: "integer", minimum: 0 },
              monthly_salary: { type: "number", minimum: 0 },
              organization_address: { type: "string" },
              manager_name: { type: "string" },
              manager_phone: { type: "string", pattern: "^\\d{8}$" },
            },
          },
        },
      },
