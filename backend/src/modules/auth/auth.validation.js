  ...
  body: z
    .object({
      ...
      birth_date: z
        ...
        .regex(
          /^\d{4}-\d{2}-\d{2}$/,
          "Төрсөн огноо YYYY-MM-DD форматтай байна.",
        ),
      phone: z
        .string()
        .trim()
      ...
      username: z
        .string()
        .trim()
        .min(3, "Username хамгийн багадаа 3 тэмдэгт байна.")
        .max(50)
        .toLowerCase()
        .optional(),
    })
...
export const passwordSchema = z.object({
  body: z
    .object({
      ...
      newPass: z
        .string()
        .min(8, "Дор хаяж 8 тэмдэгттэй шинэ нууц үгийг оруулна уу.")
    ...
    .refine((data) => data.newPass === data.confirmPass, {
      message:
        "Шинэ нууц үг болон давтан оруулсан шинэ нууц үг таарахгүй байна.",
      path: ["confirmPass"],
    }),
  params: z.object({}),
  query: z.object({}),
...
export const resetPasswordSchema = z.object({
  body: z
    .object({
      token: z.string().trim().min(20, "Нууц үг сэргээх token буруу байна."),
      newPassword: z
        .string()
